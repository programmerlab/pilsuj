...
;(function($, undefined) {
	'use strict';
	// topdeal image data-uri bypasses webkit log warning (thx doug jones)
	var TOPDEAL = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==';
	...
	$.fn.imagesLoaded = function( callback ) {
		...
		function imgLoaded( img, isBroken ) {
			// don't proceed if TOPDEAL image, or image is already loaded
			if ( img.src === TOPDEAL || $.inArray( img, loaded ) !== -1 ) {
				return;
			}
