...
<div class="top-form top-form-minicart topdeal-minicart3 pull-right">
	<div class="top-minicart-icon pull-right">
		...
		<div class="title-cart">
			...
			<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e('View your shopping cart', 'topdeal'); ?>"><?php echo '<span class="minicart-numbers">'.$woocommerce->cart->cart_contents_count.'</span>';  esc_html_e(' item(s)', 'topdeal');?> :  <?php echo $woocommerce->cart->get_cart_total(); ?></a>
		</div>
	</div>
						...
						<div class="detail-item">
							<div class="product-details"> 
								...
								<div class="product-action clearfix">
									<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="btn-remove" title="%s"><span class="fa fa-trash-o"></span></a>', esc_url( $woocommerce->cart->get_remove_url( $cart_item_key ) ), esc_html__( 'Remove this item', 'topdeal' ) ), $cart_item_key ); ?>           
