<?php
class Topdeal_Options_button_set extends Topdeal_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('topdeal-opts-jquery-ui-css');

		wp_enqueue_script(
			'topdeal-opts-field-button_set-js', 
			TOPDEAL_OPTIONS_URL.'fields/button_set/field_button_set.js', 
